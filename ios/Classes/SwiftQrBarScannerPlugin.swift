...
public class SwiftQrBarScannerPlugin: NSObject, FlutterPlugin {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "com.github.contactlutforrahman/flutter_qr_bar_scanner", binaryMessenger: registrar.messenger());
    let instance = SwiftQrBarScannerPlugin(channel: channel, textureRegistry: registrar.textures());
